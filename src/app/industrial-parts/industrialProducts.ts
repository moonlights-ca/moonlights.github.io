...
export const industrialCategories: IndustrialCategory[] = [
  ...
  },
  {
    ...
    products: [
      { slug: "heat-shrink-tubing", name: "Heat Shrink Tubing", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "2:1 and 3:1 shrink ratio, 600V, polyolefin, adhesive-lined options", category: "Cable Accessories" },
      { slug: "cable-tie-nylon-66", name: "Cable Tie Nylon 6/6", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "UV-resistant, 18–175 lb tensile, 4\"–36\" lengths, UL Listed", category: "Cable Accessories" },
      { slug: "spiral-wrap-tubing", name: "Spiral Wrap Tubing", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Polyethylene, 1/4\"–2\" diameter, -60°C to 80°C, flame retardant", category: "Cable Accessories" },
      { slug: "cord-grip-strain-relief", name: "Cord Grip / Strain Relief", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Liquid-tight, 1/2\"–2\" NPT, nylon/aluminum, 0.12\"–1.85\" cable OD", category: "Cable Accessories" },
      { slug: "wire-duct-slotted", name: "Slotted Wire Duct", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "PVC, 1\"×1\" to 4\"×4\", UL94 V-0 flame rating, snap-on cover", category: "Cable Accessories" },
      { slug: "split-loom-tubing", name: "Split Loom Tubing", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Corrugated polyethylene, 1/4\"–2\", -40°C to 105°C, easy retrofit", category: "Cable Accessories" },
    ],
  },
  {
    ...
    products: [
      { slug: "copper-compression-lug", name: "Copper Compression Lug", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Tin-plated copper, 8 AWG–750 kcmil, 1-hole or 2-hole, UL Listed", category: "Terminals & Lugs" },
      { slug: "vinyl-insulated-ring-terminal", name: "Vinyl Insulated Ring Terminal", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "22–10 AWG, #6–1/2\" stud, 600V, color-coded (red/blue/yellow)", category: "Terminals & Lugs" },
      { slug: "nylon-insulated-fork-terminal", name: "Nylon Insulated Fork Terminal", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "22–10 AWG, #4–#10 stud, 600V, flanged for easy installation", category: "Terminals & Lugs" },
      { slug: "butt-splice-connector", name: "Butt Splice Connector", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Nylon insulated, 22–10 AWG, seamless barrel, 600V rated", category: "Terminals & Lugs" },
      { slug: "mechanical-set-screw-lug", name: "Mechanical Set-Screw Lug", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Aluminum/copper rated, 14 AWG–500 kcmil, dual rated AL/CU", category: "Terminals & Lugs" },
      { slug: "din-rail-terminal-block", name: "DIN Rail Terminal Block", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Screw-clamp, 24–6 AWG, 600V/50A, touch-safe design, UL 1059", category: "Terminals & Lugs" },
    ],
  },
  {
    slug: "switches",
    ...
    products: [
      { slug: "toggle-switch-heavy-duty", name: "Heavy-Duty Toggle Switch", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "SPDT/DPDT, 20A/125V or 15A/277V, screw terminal, UL Listed", category: "Switches" },
      { slug: "rotary-cam-switch", name: "Rotary Cam Switch", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "3-position, 16–125A, 600V, panel mount, IP65 available", category: "Switches" },
      { slug: "limit-switch-industrial", name: "Industrial Limit Switch", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "Roller lever, 10A/600V, NEMA 4/13, adjustable operating head", category: "Switches" },
      { slug: "safety-disconnect-switch", name: "Safety Disconnect Switch", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "Non-fusible, 30–600A, 600V, NEMA 1/3R, flange or hub mount", category: "Switches" },
      { slug: "emergency-stop-pushbutton", name: "Emergency Stop Pushbutton", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "40mm mushroom head, twist-release, 1NC contact, IP65, red/yellow", category: "Switches" },
      { slug: "rocker-switch-illuminated", name: "Illuminated Rocker Switch", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "SPST/DPST, 20A/125V, LED indicator, snap-in panel mount", category: "Switches" },
    ],
  },
  {
  ...
  },
  {
    ...
    products: [
      { slug: "thin-wall-heat-shrink-2-to-1-colors", name: "Thin Wall Heat Shrink 2 To 1 Colors", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Industrial grade, RoHS compliant, UL Listed.", category: "Heat Shrink Tubing" },
      { slug: "discount-heat-shrink-tubing", name: "Discount Heat Shrink Tubing", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Industrial grade, RoHS compliant, UL Listed.", category: "Heat Shrink Tubing" },
      { slug: "adhesive-lined-heat-shrink-3-to-1", name: "Adhesive Lined Heat Shrink 3 To 1", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Industrial grade, RoHS compliant, UL Listed.", category: "Heat Shrink Tubing" },
      { slug: "adhesive-lined-heat-shrink-tubing-medium-wall", name: "Adhesive Lined Heat Shrink Tubing Medium Wall", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Industrial grade, RoHS compliant, UL Listed.", category: "Heat Shrink Tubing" },
      { slug: "thick-wall-adhesive-direct-burial", name: "Thick Wall Adhesive Direct Burial", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Industrial grade, RoHS compliant, UL Listed.", category: "Heat Shrink Tubing" },
      { slug: "adhesive-lined-spools", name: "Adhesive Lined Spools", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Industrial grade, RoHS compliant, UL Listed.", category: "Heat Shrink Tubing" },
      { slug: "heat-shrink-for-electric-vehicles", name: "Heat Shrink For Electric Vehicles", img: "/moonlights.github.io/assets/industrial_terminals.webp", spec: "Industrial grade, RoHS compliant, UL Listed.", category: "Heat Shrink Tubing" },
    ],
  },
  {
    ...
    products: [
      { slug: "wire-marker-books", name: "Wire Marker Books", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Pre-printed 0–9 and A–Z, vinyl cloth, self-laminating, UL Listed.", category: "Wire Markers & Labels" },
      { slug: "heat-shrink-wire-labels", name: "Heat Shrink Wire Labels", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Thermal-transfer printable, 3:1 shrink, oil/solvent resistant.", category: "Wire Markers & Labels" },
      { slug: "self-laminating-wrap-labels", name: "Self-Laminating Wrap Labels", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Clear protective tail, smudge-proof, for wire and cable.", category: "Wire Markers & Labels" },
      { slug: "wraparound-cable-markers", name: "Wraparound Cable Markers", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Write-on PVC, self-adhesive, weatherproof, color-coded.", category: "Wire Markers & Labels" },
      { slug: "clip-on-wire-markers", name: "Clip-On Wire Markers", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "PVC, snap-on, reusable, 18–10 AWG, numbered and lettered.", category: "Wire Markers & Labels" },
      { slug: "arc-flash-warning-labels", name: "Arc Flash Warning Labels", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "NEC 110.16 compliant, UV-resistant, polyester, self-adhesive.", category: "Wire Markers & Labels" },
      { slug: "voltage-marker-labels", name: "Voltage Marker Labels", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Pressure-sensitive vinyl, 480V/277V/240V/120V, high-visibility.", category: "Wire Markers & Labels" },
    ],
  },
  {
    ...
    products: [
      { slug: "solder-seal-heat-shrink-connectors", name: "Solder Seal Heat Shrink Connectors", img: "/moonlights.github.io/assets/industrial_connectors.webp", spec: "Low-temp solder ring, dual adhesive seal, 26–10 AWG, waterproof.", category: "Solder Seal & Splice Connectors" },
      { slug: "waterproof-butt-splice-connectors", name: "Waterproof Butt Splice Connectors", img: "/moonlights.github.io/assets/industrial_connectors.webp", spec: "Adhesive-lined heat shrink barrel, tinned copper, IP67, 22–10 AWG.", category: "Solder Seal & Splice Connectors" },
      { slug: "push-in-wire-connectors", name: "Push-In Wire Connectors", img: "/moonlights.github.io/assets/industrial_connectors.webp", spec: "Lever or push-in, 2–8 port, 24–10 AWG, 600V, transparent housing.", category: "Solder Seal & Splice Connectors" },
      { slug: "twist-on-wire-nuts", name: "Twist-On Wire Nuts", img: "/moonlights.github.io/assets/industrial_connectors.webp", spec: "Color-coded, 22–6 AWG range, live-action spring, UL 486C.", category: "Solder Seal & Splice Connectors" },
      { slug: "waterproof-wire-nuts", name: "Waterproof Wire Nuts", img: "/moonlights.github.io/assets/industrial_connectors.webp", spec: "Pre-filled silicone sealant, direct burial rated, 22–8 AWG.", category: "Solder Seal & Splice Connectors" },
      { slug: "in-line-splice-connectors", name: "In-Line Splice Connectors", img: "/moonlights.github.io/assets/industrial_connectors.webp", spec: "Heat shrink, single-wire pass-through, tinned barrel, IP68.", category: "Solder Seal & Splice Connectors" },
    ],
  },
  {
    ...
    products: [
      { slug: "din-rail-35mm-slotted", name: "DIN Rail 35mm Slotted", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "35mm × 7.5mm, slotted steel, zinc plated, 1m and 2m lengths.", category: "Panel & Enclosure Accessories" },
      { slug: "slotted-wire-duct-with-cover", name: "Slotted Wire Duct with Cover", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "PVC, 1\"–4\" widths, UL94 V-0, narrow/wide finger, gray.", category: "Panel & Enclosure Accessories" },
      { slug: "panel-cooling-filter-fan", name: "Panel Cooling Filter Fan", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "115/230V, 50–200 CFM, IP54, snap-in, replaceable filter mat.", category: "Panel & Enclosure Accessories" },
      { slug: "enclosure-thermostat", name: "Enclosure Thermostat", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "NC/NO, 32–140°F adjustable, DIN-rail clip, 250V/10A contact.", category: "Panel & Enclosure Accessories" },
      { slug: "end-brackets-din-rail", name: "DIN Rail End Brackets", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "Screw-clamp, for terminal blocks, polyamide, gray, 6–10mm.", category: "Panel & Enclosure Accessories" },
      { slug: "panel-mount-led-indicators", name: "Panel-Mount LED Indicators", img: "/moonlights.github.io/assets/industrial_switches.webp", spec: "22mm, 24V/120V/240V, red/green/amber, IP65, chrome bezel.", category: "Panel & Enclosure Accessories" },
    ],
  },
  {
    ...
    products: [
      { slug: "rubber-grommets-assortment", name: "Rubber Grommets Assortment", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "EPDM rubber, 1/8\"–2\" hole sizes, oil resistant, assorted kit.", category: "Grommets, Bushings & Plugs" },
      { slug: "snap-in-nylon-bushings", name: "Snap-In Nylon Bushings", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Nylon 6/6, push-in, smooth bore, 3/8\"–2\", flame retardant.", category: "Grommets, Bushings & Plugs" },
      { slug: "plastic-hole-plugs", name: "Plastic Hole Plugs", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "LDPE, snap-in, 1/4\"–2-1/2\", black, seals unused knockouts.", category: "Grommets, Bushings & Plugs" },
      { slug: "liquid-tight-cord-grips", name: "Liquid-Tight Cord Grips", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Nylon, 1/2\"–2\" NPT, IP68, with sealing ring and locknut.", category: "Grommets, Bushings & Plugs" },
      { slug: "edge-trim-grommet-strip", name: "Edge Trim Grommet Strip", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "PVC with steel clip core, 1/16\"–1/4\" edge, by-the-foot.", category: "Grommets, Bushings & Plugs" },
      { slug: "snap-bushing-oval", name: "Oval Snap Bushings", img: "/moonlights.github.io/assets/industrial_accessories.webp", spec: "Nylon, oval profile, for multi-conductor pass-through, black.", category: "Grommets, Bushings & Plugs" },
    ],
  },
];
