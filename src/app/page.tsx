...
export default function Home() {
  return (
    <main className="w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10 flex-grow">
      {/* Lockscreen-Style Depth Hero */}
      <section className="hero-depth-section relative min-h-[600px] md:min-h-[70vh] lg:min-h-[85vh] mt-8 overflow-hidden rounded-2xl border border-outline-variant/30">
        <HeroTilt>
          {/* Layer 1: Background image (behind text) */}
          <ScrollParallax speed={0.2} zIndex={0}>
            <Image
              alt="LED strip lighting product showcase"
              className="w-full h-full object-cover object-bottom scale-110 origin-top"
              src="/assets/hero_led_minimal.png"
              fill
              priority
              sizes="100vw"
            />
          ...
          {/* Layer 2: Overlay text — giant display typography */}
          <ScrollParallax speed={0.4} zIndex={10} className="flex flex-col items-center justify-center pointer-events-none">
            <h1 className="hero-depth-text font-display-lg font-black text-center leading-[0.85] select-none text-white/90" style={{ fontSize: 'clamp(4rem, 12vw, 11rem)' }}>
              Powering<br />Industry.
            </h1>
          </ScrollParallax>

          {/* Layer 3: Foreground image (in front of text — creates depth) */}
          <ScrollParallax speed={0.2} zIndex={20} className="hero-depth-foreground pointer-events-none">
            <Image
              alt=""
              className="w-full h-full object-cover object-bottom scale-110 origin-top"
              src="/assets/hero_led_minimal.png"
          ...
          {/* Layer 4: Bottom gradient scrim + CTA content */}
          <div className="absolute inset-0 z-30 flex flex-col justify-between pointer-events-none">
            ...
            <div className="bg-gradient-to-t from-black/80 via-black/40 to-transparent pt-32 pb-10 px-8 md:px-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pointer-events-auto">
                ...
                <Link
                  className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white/10 backdrop-blur-md border border-white/30 text-white font-body-md text-body-md font-bold hover:bg-white/20 hover:border-white/50 transition-all duration-300"
