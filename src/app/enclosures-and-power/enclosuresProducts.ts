...
export const enclosuresCategories: EnclosuresCategory[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { slug: "asco-185-series-manual-transfer-switch", name: "ASCO 185 Series Manual Transfer Switch 100A", img: "/moonlights.github.io/assets/asco_185_series_manual_ats.webp", spec: "100A, 2-pole, 240V, NEMA 1, double-throw, non-automatic", category: "Transfer Switches & Generators" },
      { slug: "reliance-310crk-generator-interlock", name: "Reliance 310CRK Generator Interlock Kit", img: "/moonlights.github.io/assets/reliance_310crk_interlock.webp", spec: "For listed panels, mechanical interlock, code-compliant, with hardware", category: "Transfer Switches & Generators" },
      { slug: "eaton-ch-power-inlet-box-50a", name: "Eaton CH Power Inlet Box 50A", img: "/moonlights.github.io/assets/eaton_ch_power_inlet_box.webp", spec: "50A, NEMA 3R, generator-ready, weatherproof flip lid, L14-50 inlet", category: "Transfer Switches & Generators" },
      { slug: "asco-7000-series-ats-400a", name: "ASCO 7000 Series Automatic Transfer Switch 400A", img: "/moonlights.github.io/assets/asco_7000_series_ats_400a.webp", spec: "400A, 3-pole, 480V, microprocessor controller, NEMA 1, UL 1008", category: "Transfer Switches & Generators" },
      { slug: "generac-protector-rd03524-standby-generator", name: "Generac RD03524 Protector Series Standby Generator 35kW", img: "/moonlights.github.io/assets/generac_protector_rd03524.webp", spec: "35kW, liquid-cooled diesel, 3-phase, aluminum enclosure, Wi-Fi monitoring", category: "Transfer Switches & Generators" },
    ],
  },
  {
    ...
    products: [
      ...
      { slug: "milbank-u4801-xl-meter-main-combo", name: "Milbank U4801-XL-5T9 Meter-Main Combo 200A", img: "/moonlights.github.io/assets/milbank_u4801_xl_meter_main.webp", spec: "200A, ring-type, single-phase, NEMA 3R, main breaker, 8-space", category: "Meter Sockets & Metering" },
      { slug: "durham-mhc612-ct-cabinet", name: "Durham MHC612 Current Transformer Cabinet 12\"", img: "/moonlights.github.io/assets/durham_mhc612_ct_cabinet.webp", spec: "12\" × 12\" × 6\", NEMA 3R, hinged cover, sealable, painted steel", category: "Meter Sockets & Metering" },
      { slug: "schneider-pm5560-power-meter", name: "Schneider PowerLogic PM5560 Power Meter", img: "/moonlights.github.io/assets/schneider_pm5560_power_meter.webp", spec: "Class 0.2S, Modbus TCP/Ethernet, harmonics to 63rd, 2 logical I/O", category: "Meter Sockets & Metering" },
      { slug: "milbank-u5168-6-gang-meter", name: "Milbank U5168 6-Gang Meter Stack 600A", img: "/moonlights.github.io/assets/milbank_u5168_6_gang_meter.webp", spec: "600A main bus, 6 positions (200A each), NEMA 3R, ringless, single-phase", category: "Meter Sockets & Metering" },
      { slug: "ekm-omnimeter-pulse-v4", name: "EKM Omnimeter Pulse v.4 Universal Submeter", img: "/moonlights.github.io/assets/ekm_omnimeter_pulse_v4.webp", spec: "120V–480V, 3-phase/single-phase, Modbus RS-485, revenue grade", category: "Meter Sockets & Metering" },
    ],
  },
  {
    ...
    products: [
      ...
      { slug: "eaton-pow-r-way-busplug-100a", name: "Eaton Pow-R-Way III Fusible Bus Plug 100A", img: "/moonlights.github.io/assets/eaton_pow_r_way_bus_plug.webp", spec: "100A, 3-pole, fusible disconnect, Class J fuses, plug-in, NEMA 1", category: "Busway & Bus Plugs" },
      { slug: "square-d-i-line-busway-400a", name: "Square D I-Line II Busway 400A × 10ft", img: "/moonlights.github.io/assets/square_d_i_line_busway.webp", spec: "400A, 3-phase 4-wire, aluminum bus, plug-in openings every 2ft", category: "Busway & Bus Plugs" },
      { slug: "siemens-busway-breaker-plug-60a", name: "Siemens Circuit Breaker Bus Plug 60A", img: "/moonlights.github.io/assets/siemens_circuit_breaker_bus_plug.webp", spec: "60A, 3-pole, molded case breaker, plug-in, interlocked handle", category: "Busway & Bus Plugs" },
      { slug: "eaton-busway-elbow-fitting", name: "Eaton Pow-R-Way Edgewise Elbow Fitting", img: "/moonlights.github.io/assets/eaton_pow_r_way_elbow.webp", spec: "90° edgewise elbow, matches feeder rating, copper/aluminum bus", category: "Busway & Bus Plugs" },
      { slug: "square-d-busway-end-closure", name: "Square D I-Line Busway End Closure", img: "/moonlights.github.io/assets/square_d_i_line_end_closure.webp", spec: "End cap closure, NEMA 1, fits I-Line II busway, includes hardware", category: "Busway & Bus Plugs" },
    ],
  },
  {
    ...
    products: [
      ...
      { slug: "tork-1101-time-switch", name: "Tork 1101 7-Day Time Switch 40A", img: "/moonlights.github.io/assets/tork_1101_7_day_timer.webp", spec: "120V, 40A, SPST, 7-day, mechanical, NEMA 1 metal enclosure", category: "Lighting Contactors & Timers" },
      { slug: "asco-917-lighting-contactor-30a", name: "ASCO 917 Electrically Held Lighting Contactor 30A", img: "/moonlights.github.io/assets/asco_917_lighting_contactor.webp", spec: "30A, 4-pole, 277V coil, electrically held, NEMA 1, UL 508", category: "Lighting Contactors & Timers" },
      { slug: "eaton-c30cnm30a-lighting-contactor", name: "Eaton C30CNM30A Mechanically Held Lighting Contactor", img: "/moonlights.github.io/assets/eaton_c30cnm30a_contactor.webp", spec: "30A, 3-pole, mechanically held, 120V coil, NEMA 1 enclosure", category: "Lighting Contactors & Timers" },
      { slug: "intermatic-k4121c-photocontrol", name: "Intermatic K4121C Photocontrol 105–285V", img: "/moonlights.github.io/assets/intermatic_k4121c_photocontrol.webp", spec: "105–285V, 1800VA tungsten, thermal-type, locking mount, dusk-to-dawn", category: "Lighting Contactors & Timers" },
      { slug: "intermatic-et90115c-astronomic-timer", name: "Intermatic ET90115C 365-Day Astronomic Timer", img: "/moonlights.github.io/assets/intermatic_et90115c_astronomic.webp", spec: "120–277V, 30A, 1-circuit, astronomic, battery backup, NEMA 1", category: "Lighting Contactors & Timers" },
    ],
  },
];
