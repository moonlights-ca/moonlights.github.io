...
export const toolsCategories: ToolsCategory[] = [
  {
    ...
    products: [
      { slug: "klein-11061-wire-stripper", name: "Klein 11061 Wire Stripper/Cutter", img: "/moonlights.github.io/assets/klein_11061_wire_stripper.png", spec: "Self-adjusting stripper, 10–20 AWG solid/stranded, spring-loaded", category: "Cable & Wire Tools" },
      { slug: "knipex-9512-cable-shears", name: "Knipex 95 12 200 Cable Shears", img: "/moonlights.github.io/assets/knipex_9512_cable_shears.png", spec: "200mm, two-component handles, copper/aluminum up to 70mm²", category: "Cable & Wire Tools" },
      { slug: "greenlee-k05-1gl-crimper", name: "Greenlee K05-1GL Hydraulic Crimper", img: "/moonlights.github.io/assets/greenlee_k05_1gl_crimper.png", spec: "Dieless, 6 ton, 8 AWG–750 kcmil, 360° rotating head", category: "Cable & Wire Tools" },
      { slug: "ideal-45-120-t-stripper", name: "Ideal 45-120 T-Stripper", img: "/moonlights.github.io/assets/ideal_45_120_t_stripper.png", spec: "Wire stripper for 8–18 AWG solid/10–20 AWG stranded, precision ground", category: "Cable & Wire Tools" },
      { slug: "klein-56005-fish-tape-steel", name: "Klein 56005 Steel Fish Tape 100ft", img: "/moonlights.github.io/assets/klein_56005_fish_tape_steel.png", spec: "1/8\" wide flat steel, 100ft, high-visibility orange case, laser-etched marks", category: "Cable & Wire Tools" },
