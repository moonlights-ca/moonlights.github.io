        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
          ...
          >
            <Image
              ...
              className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-all duration-500 mix-blend-luminosity group-hover:mix-blend-normal grayscale group-hover:grayscale-0"
              src="/assets/transformers_hero.png"
              fill
              sizes="(max-width: 768px) 100vw, 50vw"
              loading="lazy"
            />
      ...
      <section className="py-stack-xl border-t border-outline-variant/20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden border border-outline-variant/30 bg-surface-container-low aspect-[16/9] lg:aspect-auto group">
            <div className="absolute inset-0 bg-[url('/assets/schema_bg.jpg')] bg-cover bg-center opacity-40 group-hover:opacity-60 transition-all duration-700 grayscale group-hover:grayscale-0 mix-blend-luminosity group-hover:mix-blend-normal"></div>
